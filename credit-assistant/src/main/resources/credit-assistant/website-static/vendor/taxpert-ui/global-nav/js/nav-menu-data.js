...
export const DEFAULT_MENU = [
  {
    ...
    children: [
      ...
      // Path Mode is its own destination, not a mode of Browse All: it happens to be served by
      // the same generated page, distinguished by `?mode=path` (see currentMode() in
      // all-screens-toolbar.js). Refine once it gets a route of its own.
      { id: 'path-mode', label: 'Path Mode', href: '/app/eitc/all-screens/?mode=path' },
    ],
  },
  { id: 'fact-explorer', label: 'Fact Explorer', href: 'http://localhost:5180/studio' },
  { id: 'authoring-suite', label: 'Authoring Suite', href: '/app/eitc/author/' },
]
