...
This directory contains configurations for templates that allow you to quickly repeat common boilerplate using IntelliJ's [Live Templates](https://www.jetbrains.com/help/idea/using-live-templates.html).
